...
public class MemoryTaskSolutionTest {
    ...
    private static final int INITIAL_PRIORITY = 110;
    private static final int INITIAL_MEMORY_SIZE = 4096;
    private static final int INITIAL_BANDWIDTH = 2000;
    private static final Memory INITIAL_MEMORY_TYPE = Memory.VRAM;
    ...
    @ParameterizedTest
    @ValueSource(ints = {0, -5, -200, Integer.MIN_VALUE})
    ...
    @ParameterizedTest
    @ValueSource(ints = {1, 100, 2000, 5000, Integer.MAX_VALUE})
