...
public class ComputeTaskSolutionTest {
    ...
    @ParameterizedTest
    @ValueSource(ints = {0, -3, -10, Integer.MIN_VALUE})
    ...
    @ParameterizedTest
    @ValueSource(ints = {1, 3, 6, 12, 32, Integer.MAX_VALUE})
    ...
    @CsvSource({
            "6, 24, 1.44",   // Base case
            "12, 48, 5.76",  // Higher values
            "3, 12, 0.36",   // Lower values
            "1, 4, 0.04"     // Minimum values
    })
    ...
    void testExecutionTimeCalculation() {
        ...
        task.setComputeUnits(6);
        task.setBatchSize(48);

        double expectedFactor = (1.0 / 6) * (48.0 / 16.0);
